...
| Field 2h soak | **OPTIONAL; r3 PASS (evidence); r2 FAIL retained** | r3: wall 7200s + `all_iters_ok=true` (12/12 exit 0; CSRF minted). Evidence `.tmp-1401-field-soak-r3/soak_final.json`. Not Companion / not Production GO. FE-SEC-02 flags-on https verify **HANDOFF READY** — [`PHASE1_FE_SEC_02_DEVOPS_FLAGS_ON_HANDOFF.md`](PHASE1_FE_SEC_02_DEVOPS_FLAGS_ON_HANDOFF.md) · flags **OFF** until DevOps enable window · tip lineage ~`100cce8`/`3fccbe6` |
