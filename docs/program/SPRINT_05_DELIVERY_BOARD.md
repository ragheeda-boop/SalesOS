...
| CI-07 | MyPy/Ruff `cli/` path in CI (triage #1/#2 partial) — remove non-existent `cli/` from `mypy`/`ruff` invocations | P1 | PENDING | |
...
| CI-06 | Deploy Production commit-comment permissions (triage #14) — add `permissions: contents: write` | P1 | PENDING | |
...
## Progress
- Complete/Closed: 10/19 (CI-01, CI-11, S04-01, CI-15, CI-02, CI-03, CI-04, CI-05, CI-18, CI-17). Blocked: CI-08, S04-04, CI-09. Registered: CI-14, CI-19. Backlog: DB-05, CI-16.
