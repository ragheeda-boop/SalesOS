...
| **CI-19** Semgrep Waves 2–5 | IN PROGRESS / PARALLEL | Wave 1 COMPLETE (`d5c9b57`); Wave 3 COMPLETE (DEC-069 SHA-pin + DEC-074 K8s/Docker/TF); Wave 4 COMPLETE (DEC-076 / `5c27470`); Wave 5 COMPLETE (DEC-080); Wave 2 deferred | Next: Wave 2 SQL honesty (when authorized); R-24 mitigating |
...
|---|---|---|
| **CI-20**, **CI-19 Wave 5**, **CI-22**, **CI-14** | PARALLEL / READY | Explicitly unblocked for Sprint 05/06 execution while S04-04 waits on human auth. **Jest-debt CLOSED** (DEC-077) |
