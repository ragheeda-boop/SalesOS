...
|---|---|---|
| Contract tests, optional Jest 30, EOS **4.1/4.8**, Arch/Val on **9.3** | PARALLEL / READY | DEC-107 swarm; Eng Stability **COMPLETE 4/4**; **9.3 READY FOR REVIEW** (DEC-146); next OPEN after 9.3 CLOSE: EOS **4.1/4.8** (ARB — do not invent); CI **3.5/3.7/3.8** (non-GHCR); ops CI-08/CI-09; do **not** claim Phase 0 GO |
