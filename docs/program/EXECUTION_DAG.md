...
| **Jest-debt** (Sprint 01 suite remediation) | READY / PARALLEL | FE-only; §8 field **11** fail (`30677189129`); contract −3 at `4fdc1d8`; **holdout H1–H8** documented DEC-067 / `JEST_BASELINE.md` §9 | Expected ceiling **≤8** pending Stage 3 field verify; holdout **code** = Frontend Lead; support docs only in DEC-067 |
