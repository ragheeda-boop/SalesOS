...
| **CI-14** Frontend Dependency Modernization | READY / PARALLEL (Sprint 06) | REGISTERED; **plan DEC-062**; dep CI-13 baseline closed; Slice 1 (sharp) pending auth | Majors — R-18; STOP silent Next/React/ESLint/Jest / Next↓14 |
