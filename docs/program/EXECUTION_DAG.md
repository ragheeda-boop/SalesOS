...
|---|---|---|
| Contract tests, optional Jest 30, EOS **4.1/4.8** | PARALLEL / READY | DEC-107 swarm; Capability Drift **COMPLETE 4/4** (DEC-134a); ADR Drift **COMPLETE 5/5** (DEC-139a); **4.5 CLOSED** (DEC-140a); **9.2 CLOSED** (DEC-141a); **4.2/4.4/4.7 CLOSED** (DEC-142a); **8.1 CLOSED** (DEC-143a); **8.3 CLOSED CONDITIONAL** (DEC-144a); **8.2 CLOSED CONDITIONAL** (DEC-145a); Eng Stability **COMPLETE 4/4**; next OPEN: EOS **4.1/4.8** (ARB); ops CI-08/CI-09; do **not** claim Phase 0 GO |
