...
| **CI-19** Semgrep Waves 2–5 | IN PROGRESS / PARALLEL | Wave 1 COMPLETE (`d5c9b57`); Wave 3 COMPLETE (DEC-069 SHA-pin + DEC-074 K8s/Docker/TF); Wave 4 COMPLETE (DEC-076 / `5c27470`); Wave 5 COMPLETE (DEC-082); Wave 2 deferred | Next: Wave 2 SQL honesty (when authorized); R-24 mitigating |
