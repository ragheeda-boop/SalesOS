...
|---|---|---|
| Contract tests, optional Jest 30, EOS **4.1/4.8**, CI **3.7/3.8** | PARALLEL / READY | DEC-107 swarm; Eng Stability **COMPLETE 4/4**; ADR-036 Applied **COMPLETE 4/4** (DEC-146a); **3.5 RFR** (DEC-147); hard OPEN: EOS **4.1/4.8** (ARB — do not invent); CI **3.7** (E2E/services + Stage 6 dep) · **3.8** (tip code-path); BLOCKED ops CI-08/CI-09; do **not** claim Phase 0 GO |
