...
|---|---|---|---|
| **CI-20** Backend Types (MyPy) | IN PROGRESS / PARALLEL (phased) | Phase 1 COMPLETE at `65296174` (admin 34→0; ~308→~274); Phase 2 COMPLETE at `01b6a8ae` (company 25→0; ~274→~249 expected); Phase 3 COMPLETE at `e5b4471` (entity_resolution 14→0; ~249→~235 expected); Phase 4 COMPLETE at `4b3a436` (identity 16→0; ~235→~219 expected); story OPEN; Backend Lint already green | DEC-038 register; DEC-046 Phase 1; DEC-047 Phase 2; DEC-048 Phase 3; DEC-049 Phase 4 — **not CLOSED** |
