...
| **DB-05** Schema reconciliation | IN PROGRESS | Slice 0–4 CLOSED (7.5/7.4); **Slice 5a COMPLETE** (DEC-130 READY FOR REVIEW); prod tip `d1a8` / POLICY_COUNT **67** | Residual **7.6 OPEN** (live check FAILED; phased 5b–5f+); prior “prod on 59” residual cleared (`c842245`) |
...
| **DB-05 7.6** alembic check | **OPEN** (Slice 5a DEC-130 READY FOR REVIEW) | Live check FAILED @ `d1a8c35e7f09`; phased 5b+; do **not** CLOSE |
...
|---|---|---|
| Contract tests, optional Jest 30, DB-05 7.6 Slice 5b+ | PARALLEL / READY | DEC-107 swarm; 7.6 OPEN after Slice 5a DEC-130 (live check FAILED); next metadata classify — do **not** claim Phase 0 GO |
