...
|---|---|---|
| Contract tests, optional Jest 30, ADR Drift **6.x** / EOS **4.x** / Eng Stability **8.x** | PARALLEL / READY | DEC-107 swarm; Capability Drift **COMPLETE 4/4** (DEC-134a); do **not** claim Phase 0 GO |
