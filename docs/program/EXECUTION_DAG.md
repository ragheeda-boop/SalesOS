...
| **DB-05** Schema reconciliation | IN PROGRESS | Slice 0–4 CLOSED (7.5/7.4); **Slice 5a–5g COMPLETE** (DEC-130…DEC-130g READY FOR REVIEW); head `a4f7c29e1b80`; prod tip was `d1a8` / POLICY_COUNT **67** | Residual **7.6 OPEN** (check **exit 0** evidenced; Arch+Val then Orchestrator CLOSE); prior “prod on 59” residual cleared (`c842245`) |
...
| **DB-05 7.6** alembic check | **OPEN** (Slice 5g DEC-130g READY FOR REVIEW) | live Docker check **exit 0** @ `a4f7c29e1b80`; Arch+Val then Orchestrator may CLOSE; do **not** claim Phase 0 GO |
...
|---|---|---|
| Contract tests, optional Jest 30, DB-05 7.6 Arch+Val | PARALLEL / READY | DEC-107 swarm; 7.6 OPEN after Slice 5g DEC-130g (check exit 0 evidenced); Orchestrator CLOSE after Arch+Val — do **not** claim Phase 0 GO |
