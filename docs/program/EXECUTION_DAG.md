...
| **DB-05** Schema reconciliation | IN PROGRESS | Slice 0–4 CLOSED (7.5/7.4); **Slice 5a+5b COMPLETE** (DEC-130 / DEC-130b READY FOR REVIEW); prod tip `d1a8` / POLICY_COUNT **67** | Residual **7.6 OPEN** (check FAILED; `remove_table` **28→15**; next 5c admin CREATE); prior “prod on 59” residual cleared (`c842245`) |
...
| **DB-05 7.6** alembic check | **OPEN** (Slice 5b DEC-130b READY FOR REVIEW) | `remove_table` **28→15**; check still FAILED @ `d1a8c35e7f09`; next 5c; do **not** CLOSE |
...
|---|---|---|
| Contract tests, optional Jest 30, DB-05 7.6 Slice 5c+ | PARALLEL / READY | DEC-107 swarm; 7.6 OPEN after Slice 5b DEC-130b (`remove_table` 28→15); next admin CREATE — do **not** claim Phase 0 GO |
