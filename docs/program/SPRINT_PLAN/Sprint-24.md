...
| STORY-14-04 (penetration test) | Security (+ external firm) | P0 | Critical | **CLOSED (in-repo) / IN_REPO_READY** @ `e9081d5`+: pack + findings tracker (FE-SEC-01 Fixed; FE-SEC-02/03/04 Open residual from `34f4a81`). Crumb [`PHASE1_STORY_14_04_PENTEST_CRUMB.md`](../PHASE1_STORY_14_04_PENTEST_CRUMB.md). AC "zero unresolved criticals" **not validated** (firm/retest). Firm / staging SSRF = **residual-external**. CI Security Scan ≠ pentest. No Production GO. Stage 6 SKIPPED. |
