...
| STORY-14-04 (penetration test) | Security (+ external firm) | P0 | Critical | **CLOSED (in-repo)** · **handoff READY** (brief v1.2, vendor, evidence intake). FE-SEC-02 **Open**. Tip `https://salesos-production-96c0.up.railway.app`. AC **not validated** — firm **residual-external**. No Production GO. |
