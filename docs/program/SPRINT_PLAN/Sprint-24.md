...
| STORY-14-04 (penetration test) | Security (+ external firm) | P0 | Critical | **IN FLIGHT (Board):** keep open until Board confirms in-repo close. Crumb [`PHASE1_STORY_14_04_PENTEST_CRUMB.md`](../PHASE1_STORY_14_04_PENTEST_CRUMB.md) may list pack artifacts — AC “zero unresolved criticals” **not validated** (firm/retest). External firm / staging SSRF = **residual-external**. CI Security Scan ≠ pentest. No Production GO. Stage 6 SKIPPED. |
