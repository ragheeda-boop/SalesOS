...
| STORY-12-02 (AI Policies UI) | AI-Lead | P0 | Medium | **LANDED BE (AI-Lead):** tenant AI Policies + evaluate via `/api/v1/studio/ai-policies` reusing AI-GR-001..006. Crumb [`PHASE1_STORY_12_02_AI_POLICIES_CRUMB.md`](../PHASE1_STORY_12_02_AI_POLICIES_CRUMB.md). Live LLM/RAG not claimed. `feature_ai_copilot` False. No new RLS. No Production GO. |
| STORY-12-03 (AI Memory MVP) | BE-Lead, AI-Lead | P0 | High (R-06) | Conversation-level only; adversarial cross-tenant isolation test passes — **PARK** until BE pair |
