...
| Full regression suite (final) | QA-Lead | P0 | High | **CANDIDATE RC PINNED / NOT VALIDATED:** candidate `RC_SHA`=`26f2ab5` (`26f2ab57372970b761a495eaf3949ed558830247`) — tip-line green context ≠ suite pass. Empty results tables **NOT VALIDATED**. Crumb [`PHASE1_SPRINT25_QA_REGRESSION_CRUMB.md`](../PHASE1_SPRINT25_QA_REGRESSION_CRUMB.md). Board RC declare / soak **pending**. Plan AC “100% pass vs RC” **not claimed**. No full suite run without approval. No Production GO. Stage 6 SKIPPED. |
