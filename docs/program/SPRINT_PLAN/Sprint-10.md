...
| FE-S08-15 (Cmd palette Studio steps + tip field polish) | FE-Lead | P1 | Low | **LANDED FE (Stream B):** remaining `?step=` cmd deep-links + tip `created_at`/`updated_at` + mapping id/is_active. Crumb [`PHASE1_FE_S08_15_CMD_PALETTE_TIP_POLISH_CRUMB.md`](../PHASE1_FE_S08_15_CMD_PALETTE_TIP_POLISH_CRUMB.md). No Production GO. |
