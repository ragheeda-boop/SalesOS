...
| FE-S11-09b (Sequencing multi-channel UI) | FE-Lead | P0 | Medium | **LANDED FE (Stream B):** `/gtm/sequences` channel select + enroll LI/WA handles against tip 11-09b. Crumb [`PHASE1_FE_S11_09B_SEQUENCING_MULTICHANNEL_CRUMB.md`](../PHASE1_FE_S11_09B_SEQUENCING_MULTICHANNEL_CRUMB.md). Live network not claimed. No Production GO. |
...
| FE-S11-10 (Second connector certify UI) | FE-Lead | P0 | Medium | **LANDED FE (Stream B):** `/integrations` certify meta + hubspot run against tip 11-10 HTTP. Crumb [`PHASE1_FE_S11_10_SECOND_CONNECTOR_CRUMB.md`](../PHASE1_FE_S11_10_SECOND_CONNECTOR_CRUMB.md). Live HubSpot network not claimed. No Production GO. |
