...
| STORY-13-04 (publish 3 connectors + 1 playbook) | BE2, Program Director | P0 | Medium | **LANDED BE (Stream A):** publish pack seed Odoo+HubSpot+REST/CSV + GCC playbook (`published`/`installable`); catalog install receipt + publish HTTP. Crumb [`PHASE1_STORY_13_04_PUBLISH_PACK_CRUMB.md`](../PHASE1_STORY_13_04_PUBLISH_PACK_CRUMB.md). **FE (Stream B FE-S13-04):** `/marketplace/listings` seed-publish-pack + publish + install + installs list. Catalog install ≠ live ERP. Crumb [`PHASE1_FE_S13_04_MARKETPLACE_PUBLISH_INSTALL_CRUMB.md`](../PHASE1_FE_S13_04_MARKETPLACE_PUBLISH_INSTALL_CRUMB.md). No new RLS. Not Production GO. |
