...
|---|---|---|---|---|
| STORY-11-04 (Lookalike Accounts) | AI-Lead / BE Stream A | P0 | Medium | **LANDED BE (Stream A):** versioned `LookalikeModel` via `/api/v1/gtm/lookalikes` on tenant won/lost Opportunity-shaped fixtures. Crumb [`PHASE1_STORY_11_04_LOOKALIKE_CRUMB.md`](../PHASE1_STORY_11_04_LOOKALIKE_CRUMB.md). Live Opportunity ML / 141221 not claimed. No new RLS. No Production GO. Unblocks FE-S11-04. |
| FE-S11-04 (Lookalike Accounts UI) | FE-Lead | P0 | Medium | **LANDED FE (Stream B):** `/gtm/lookalikes` against tip lookalikes HTTP. Crumb [`PHASE1_FE_S11_04_LOOKALIKE_CRUMB.md`](../PHASE1_FE_S11_04_LOOKALIKE_CRUMB.md). Live ML / 141221 not claimed. No Production GO. |
