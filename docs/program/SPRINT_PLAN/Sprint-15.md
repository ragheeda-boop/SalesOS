...
| FE-S10-07b (Branding chrome apply) | FE-Lead | P1 | Low | **LANDED FE (Stream B):** tip branding display_name + colors on dashboard chrome. Crumb [`PHASE1_FE_S10_07B_BRANDING_CHROME_CRUMB.md`](../PHASE1_FE_S10_07B_BRANDING_CHROME_CRUMB.md). No CDN logo embed. No Production GO. |
