...
| STORY-06-04 (entitlement-bypass suite) | Security | P0 | High | **LANDED (Security):** Full plan × gated-DOM adversarial matrix + middleware ASGI (entitlement denial, quota_exceeded, cross-tenant, Owner/admin skip, flags off, abuse paths). Suites `test_adversarial_entitlement_bypass_story_06_04.py`, `test_entitlement_cache_ttl_story_06_04.py`. Crumbs [PHASE1_STORY_06_04_ENTITLEMENT_BYPASS_SUITE_CRUMB.md](../PHASE1_STORY_06_04_ENTITLEMENT_BYPASS_SUITE_CRUMB.md), [PHASE1_STORY_06_04_ENTITLEMENT_CACHE_TTL_CRUMB.md](../PHASE1_STORY_06_04_ENTITLEMENT_CACHE_TTL_CRUMB.md). No Production GO. |
...
| STORY-08-02 (ExternalSystemConnection) | BE2 | P0 | High | **LANDED BE (Stream A):** `external_system_connections` Alembic `e1a7b68c2d05` + FORCE RLS; Fernet credentials + `credential_ref`; cross-tenant unit suite. Crumb [`PHASE1_STORY_08_02_EXTERNAL_SYSTEM_CONNECTION_CRUMB.md`](../PHASE1_STORY_08_02_EXTERNAL_SYSTEM_CONNECTION_CRUMB.md). No Production GO. |
