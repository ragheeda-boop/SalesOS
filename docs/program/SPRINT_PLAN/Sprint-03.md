...
| STORY-03-04 (contract test framework) | DevOps/SRE* | P1 | Medium | **DONE** | Template merged, used by first real endpoint test | Commit `623077c` — `tests/contract/` framework + csrf. Expansion **DEC-094** slice 1–3: probes + health/ready + auth `GET /api/v1/decisions` OpenAPI HTTP contracts. Next: 401/422 (honest error shapes) |
