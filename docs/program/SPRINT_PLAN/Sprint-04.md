...
| FE Stream B (Owner Console tenants) | FE-Lead | P1 | Low | **B1–B5 + B4 + FE-S04-06..45 + FE-S05-01..06 + FE-S06-01** ([`PHASE1_FE_STREAM_B_CRUMB.md`](../PHASE1_FE_STREAM_B_CRUMB.md)) | Admin billing/dunning/plan-change; `TenantList` untouched; no Production GO |
