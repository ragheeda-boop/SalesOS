...
| FE Stream B (Owner Console tenants) | FE-Lead | P1 | Low | **B1–B5 + B4 + FE-S04-06..16** ([`PHASE1_FE_STREAM_B_CRUMB.md`](../PHASE1_FE_STREAM_B_CRUMB.md)) | Admin `/admin/tenants` Owner Platform CRUD/filters incl. plan_id/trial; `TenantList` untouched; no Production GO |
