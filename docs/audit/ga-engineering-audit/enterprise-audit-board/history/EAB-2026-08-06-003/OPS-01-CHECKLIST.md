...
**Updated:** 2026-08-24 (PO signatures: rows 1–3 VERIFIED, row 8 ACCEPTED, OPS01-04 soak Option A)  
**Disposition:** Rows 01–04 and 08 signed 2026-08-24 (soak accept-with-conditions). Production GA **not** declared. Residual: Railway backup-schedule BLOCKED-HUMAN; OPS01-05 HUMAN-GO-INK. OPS01-06 reclassified per ADR-108.  
...
|----|-------------|--------|----------------|-------|----------|
| OPS01-01 | Offsite backup to durable off-box store + retention | DONE | yes | ops | PO VERIFIED 2026-08-24 (OPS01-SIGNATURE-PACK). evidence/ops01-offsite/ops01-row1-offsite-restore.json + .md (pg_dump→S3 `salesos-backups-iwrweogrr`, upload/download SHA256 verified, disposable restore=96 tables, companies 141221==live). Residual: scheduled Railway backup-schedule API BLOCKED-HUMAN |
| OPS01-02 | WAL archive on primary (or managed equivalent) to offsite | DONE | yes | ops | PO VERIFIED 2026-08-24 (OPS01-SIGNATURE-PACK). evidence/ops01-pitr/ops01-row2-wal-archiver.json + .md (primary archive_mode=on, pgBackRest push wrapper, archived_count=6/failed=0, base 20260806-192926F → bucket `salesos-pitr-w-857q3fjjrr`). Residual: managed schedule BLOCKED-HUMAN |
| OPS01-03 | PITR restore to named timestamp with evidence | DONE | yes | ops | PO VERIFIED 2026-08-24 (OPS01-SIGNATURE-PACK). evidence/ops01-pitr/ops01-row3-pitr-restore.json + .md (pgBackRest 2.59.0 restore to 19:29:50 UTC from managed archive, promote timeline 2, exact consistency vs live). Residual: native `volumeInstancePITRRestore` BLOCKED-HUMAN |
| OPS01-04 | Staging soak 48–72h (staging parity, not local-only) | DONE | yes | ops | soak_complete_claim=true (U5 2026-08-24, Option A accept-with-conditions). Evidence: SOAK-RCA / U2 / U3 / U4 / U5 2026-08-22 packs (signed 2026-08-24); 854 iters / 82 fails; 97.6% single DB/auth outage now RCA-closed. Conditions: no credential rotation during future soaks; Railway preDeployCommand vs railway.json still drifted. Does **not** declare Production GO. |
...
| OPS01-08 | RPO/RTO signed acceptance vs capability | DONE | related | Project Owner | PO ACCEPTED 2026-08-24 (OPS01-SIGNATURE-PACK). DR_RUNBOOK.md §1 reviewed: PostgreSQL RPO < 1h / RTO < 4h accepted; Redis ephemeral (no RPO/RTO); Neo4j N/A per ADR-108 |
...
|-------|-----:|--------:|-----:|--------------:|---------------:|----------------------:|
| Rows OPS01-01…08 | 6 | 0 | 0 | 0 | 1 (OPS01-06) | 1* (OPS01-05 HUMAN-GO-INK) |
| Launch blockers (01–05) | 4 | 0 | 0 | 0 | 0 | 1* (OPS01-05 HUMAN-GO-INK) |

\*OPS01-05 = human GO ink on SIGN_HERE (2026-08-08); **not** engineering DONE. Vocabulary extended: `HUMAN-GO-INK` = human Decision=GO recorded. Soak (OPS01-04) signed Option A 2026-08-24. This table does **not** declare Production GO.
