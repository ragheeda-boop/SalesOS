...
**Updated:** 2026-08-08 (OPS01-05 signature ink only)  
**Disposition:** Deferred (launch blocker — soak/residual evidence still OPEN)  
...
| OPS01-06 | Neo4j staging/prod backup-restore policy | PARTIAL | no | ops | Local neo4j-admin dump/load Wave 10; prod policy OPEN |
...
| Scope | DONE | PARTIAL | OPEN | BLOCKED-HUMAN | HUMAN-GO-INK / other |
|-------|-----:|--------:|-----:|--------------:|----------------------:|
| Rows OPS01-01…08 | 4 | 1 | 1 | 1 | 1* (OPS01-05 HUMAN-GO-INK) |
| Launch blockers (01–05) | 3 | 0 | 1 (OPS01-04) | 0 | 1* (OPS01-05 HUMAN-GO-INK) |
...
All of `OPS01-01`…`OPS01-05` must be `DONE` with linked executable evidence **and** human signatures where required before any **evidence-based** Production GO / cutover claim. `HUMAN-GO-INK` on OPS01-05 records human Decision=GO on SIGN_HERE but does **not** by itself close OPS01-04 or invent soak/DR. Local `OPS01-LOCAL-PG` alone never closes the finding.
