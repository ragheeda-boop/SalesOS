...
(POLICY_COUNT 55 = 47 Category A per DEC-044 + B1 DEC-112 + B2 DEC-114 + B3 DEC-115 + B4 DEC-116) but were not in the original sample:
...
POLICY_COUNT = 55  # 47 Category A + B1 (DEC-112) + B2 (DEC-114) + B3 (DEC-115) + B4 (DEC-116)
