...
(POLICY_COUNT 51 = 47 Category A per DEC-044 + B1 DEC-112 + B2 DEC-114) but were not in the original sample:
...
POLICY_COUNT = 51  # 47 Category A + B1 (DEC-112) + B2 (DEC-114)
