...
(POLICY_COUNT 49 = 47 Category A per DEC-044 + B1 join per DEC-112) but were not in the original sample:
...
POLICY_COUNT = 49  # 47 Category A + B1 branches/licenses (DEC-112)
