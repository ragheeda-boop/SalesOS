    ...
    def default_roles(cls) -> dict[str, list[Permission]]:
        return {
            ...
            "manager": [
                ...
                Permission("workflow", PermissionAction.READ),
                Permission("task", PermissionAction.READ),
                Permission("employee", PermissionAction.READ),
                Permission("employee-360", PermissionAction.READ),
                Permission("work-intelligence", PermissionAction.READ),
                Permission("analytics", PermissionAction.READ),
                Permission("timeline", PermissionAction.READ),
                Permission("activity", PermissionAction.READ),
                Permission("quote", PermissionAction.CREATE),
                Permission("quote", PermissionAction.READ),
                Permission("quote", PermissionAction.UPDATE),
                Permission("proposal", PermissionAction.CREATE),
                Permission("proposal", PermissionAction.READ),
                Permission("proposal", PermissionAction.UPDATE),
