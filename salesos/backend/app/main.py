...
app = FastAPI(
    title="SalesOS API",
    description=(
        "Enterprise Company Intelligence Platform — signal-driven sales actions, "
        "entity resolution, AI copilot, decision intelligence, and master data management. "
        "Multi-tenant with RLS isolation, RBAC, audit trail, and evidence-first AI."
    ),
    ...
    openapi_tags=[
        {"name": "Agent Reach", "description": "Multi-channel intelligence gathering (web, Twitter, YouTube, GitHub, RSS, LinkedIn)."},
        {"name": "Signal Actions", "description": "Signal-driven sales actions: qualify, score, execute, and complete."},
        {"name": "Human-in-the-Loop", "description": "HITL feedback, outcomes, follow-ups, work queue, and seller metrics."},
        {"name": "Business Effectiveness", "description": "Observation pipeline: cohorts, lift, monotonicity, NBA effectiveness, calibration."},
        {"name": "Signal Marketplace", "description": "Signal catalog, subscriptions, event feed, and acknowledgment."},
        {"name": "Entity Resolution", "description": "Matching pipeline, field conflicts, quality scores, merge/unmerge, provenance."},
        {"name": "Master Data", "description": "Global companies, people, legacy ID mappings, source files, and source rows."},
        {"name": "Master Data Ingestion", "description": "File ingestion pipeline with hash dedup and duplicate detection."},
        {"name": "Master Data Review Queue", "description": "Phase 7-A review queue: P3 pairs, short-CR, triage candidates, dispositions."},
        {"name": "Revenue Execution", "description": "Opportunities, tasks, and pipeline management."},
        {"name": "Decision Platform", "description": "Decision evaluation, batch processing, recommendations, rules, and learning (alternate to Decision Center SoT)."},
        {"name": "Decision Center (SoT)", "description": "Canonical governed decision ledger."},
        {"name": "Decision Runtime (remounted; deprecated /api/v1 aliases)", "description": "Decision runtime engine (deprecated path aliases)."},
        {"name": "Identity", "description": "Authentication, signup, SSO, and user management."},
        {"name": "Companies", "description": "CRM company management."},
        {"name": "Contacts", "description": "CRM contact management."},
        {"name": "Copilot", "description": "AI copilot with Ask, Explain, Summarize, Investigate, and Recommend modes."},
        {"name": "Approval", "description": "Human-in-the-loop approval workflows."},
        {"name": "Commercial", "description": "Commercial domain: opportunities, pipeline, activities."},
        {"name": "Revenue", "description": "Revenue analytics and forecasting."},
        {"name": "RAG", "description": "Retrieval-Augmented Generation with tenant-isolated document corpus."},
        {"name": "Analytics", "description": "Pipeline, team, and activity analytics cubes."},
        {"name": "GTM Intelligence", "description": "Go-to-market: ICP, market sizing, lead discovery, enrichment, outreach, sequencing."},
        {"name": "Tenant Studio", "description": "Custom fields, workflows, scoring rules, territories, permissions, branding."},
        {"name": "AI Studio", "description": "AI policies, prompt library, and AI memory."},
        {"name": "AI Model Tiers", "description": "Per-plan AI model tier configuration."},
        {"name": "Load SLO", "description": "Load and SLO testing harness."},
        {"name": "DR Drill", "description": "Disaster recovery drill: backup, restore, RTO/RPO validation."},
        {"name": "Chaos Resilience", "description": "Chaos resilience fault injection and AI provider failover."},
        {"name": "SSO", "description": "Single Sign-On integration."},
        {"name": "Event Runtime", "description": "Event bus and domain event processing."},
        {"name": "Knowledge Graph", "description": "Neo4j knowledge graph runtime."},
        {"name": "Search", "description": "Full-text and semantic search."},
        {"name": "Notifications", "description": "WebSocket and push notifications."},
        {"name": "Audit", "description": "Audit trail and compliance logging."},
        {"name": "Admin", "description": "Platform administration: tenants, users, plans, billing, feature flags."},
        {"name": "Metrics", "description": "Prometheus metrics endpoint."},
        {"name": "Settings", "description": "Tenant settings and configuration."},
        {"name": "Telemetry", "description": "Telemetry and observability."},
        {"name": "Workflow Engine", "description": "Workflow automation engine."},
        {"name": "Rules Engine", "description": "Business rules engine."},
        {"name": "Enrichment", "description": "Data enrichment pipelines."},
    ],
)
