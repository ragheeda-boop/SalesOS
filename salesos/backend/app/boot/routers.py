...
def register_routers(app: FastAPI) -> None:
    ...
    # app.modules.admin.router = Platform admin (tenants, users, plans, billing, feature flags, roles, audit log, etc.)
    ...
    app.include_router(employee_domain_router, prefix="/api/v1", tags=["Employee Domain"], dependencies=_auth)
    ...
    app.include_router(decision_center_router, prefix="/api/v1", tags=["Decision Center"], dependencies=_auth)
    ...
    app.include_router(activity_intelligence_router, tags=["Activity Intelligence"], dependencies=_auth)
