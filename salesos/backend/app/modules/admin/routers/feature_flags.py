...
async def create_feature_flag(
    body: FeatureFlagCreate, repos: AdminRepositories = Depends(get_admin_repos)
):
...
async def update_feature_flag(
    flag_id: uuid.UUID, body: FeatureFlagUpdate, repos: AdminRepositories = Depends(get_admin_repos)
):
...
async def get_feature_flag_tenants(
    flag_id: uuid.UUID, repos: AdminRepositories = Depends(get_admin_repos)
):
