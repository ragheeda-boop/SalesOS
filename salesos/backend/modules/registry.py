...
from sdk.permissions import PermissionRegistry
...
def _register_signal_marketplace() -> None:
    FeatureRegistry.register(
        FeatureModule(
            ...
            description="Signal detection, subscription, and feed from Knowledge Packs and domain events",  # noqa: E501
...
def _register_entity_resolution() -> None:
    FeatureRegistry.register(
        FeatureModule(
            ...
            description="Golden record management, identity matching, field-level conflict resolution",  # noqa: E501
...
def _register_platform_capabilities() -> None:
    ...
    CapabilityRegistry.register(
        Capability(
            ...
            description="Communication layer — references Quote revisions, never duplicates pricing",  # noqa: E501
            type=CapabilityType.DOMAIN,
            events=EventDeclaration(
                produces=[
                    "proposal.generated",
    ...
    CapabilityRegistry.register(
        Capability(
            ...
            description="Commercial agreement drafts with approval, revision control, and revenue KPIs",  # noqa: E501
            type=CapabilityType.DOMAIN,
            events=EventDeclaration(
                produces=[
                    "quote.created",
    ...
    CapabilityRegistry.register(
        Capability(
            ...
            description="Measurement Layer — owns KPIs, never facts or decisions. Snapshot-based, explainable, drill-down to RTI",  # noqa: E501
            type=CapabilityType.DOMAIN,
    ...
    CapabilityRegistry.register(
        Capability(
            ...
            description="Projection Engine — consumes commercial truths, owns predictions, never creates facts",  # noqa: E501
            type=CapabilityType.DOMAIN,
    ...
    CapabilityRegistry.register(
        Capability(
            ...
            description="Aggregates facts, knowledge, measurements, policies into contextual snapshots for recommendations",  # noqa: E501
            type=CapabilityType.DOMAIN,
    ...
    CapabilityRegistry.register(
        Capability(
            ...
            description="Consumes Decision Context, produces explainable, contextual, optional recommendations",  # noqa: E501
            type=CapabilityType.DOMAIN,
    ...
    CapabilityRegistry.register(
        Capability(
            ...
            label="Entity Resolution",
            label_ar="حل الكيانات",
            description="Golden record management with provenance, identity matching by CR number, field-level conflict detection",  # noqa: E501
            type=CapabilityType.DOMAIN,
            executors=[],
            events=EventDeclaration(
                produces=[
