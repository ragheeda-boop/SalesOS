...
class ReportModel(Base):
    ...
    type: Mapped[str] = mapped_column(String(50), nullable=False, default="custom", server_default="custom")
    config: Mapped[Any] = mapped_column(JSON, nullable=False, default=dict, server_default="{}")
    metrics: Mapped[Any] = mapped_column(JSON, nullable=False, default=list, server_default="[]")
    dimensions: Mapped[Any] = mapped_column(JSON, nullable=False, default=list, server_default="[]")
    filters: Mapped[Any] = mapped_column(JSON, nullable=False, default=dict, server_default="{}")
    visualization_type: Mapped[str] = mapped_column(String(50), nullable=False, default="table", server_default="table")
    created_by: Mapped[str] = mapped_column(String(36), nullable=False, default="", server_default="")
    schedule: Mapped[str] = mapped_column(String(100), nullable=False, default="one-time", server_default="one-time")
    recipients: Mapped[Any] = mapped_column(JSON, nullable=False, default=list, server_default="[]")
