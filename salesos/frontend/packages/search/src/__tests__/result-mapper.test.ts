...
describe("mapSearchResult", () => {
  ...
  it("maps highlights", () => {
    const r = mapSearchResult({
      ...rawResult,
      highlights: [{ field: "title", text: "أرامكو", snippets: ["أرامكو"] }],
    });
  ...
  it("maps relationships", () => {
    const r = mapSearchResult({
      ...rawResult,
      relationships: [{ id: "rel_1", type: "supplier", label: "مورد", direction: "outbound" }],
    });
  ...
  it("sanitizes relationship direction", () => {
    const r = mapSearchResult({
      ...rawResult,
      relationships: [{ id: "rel_1", type: "supplier", label: "مورد", direction: "invalid" }],
    });
