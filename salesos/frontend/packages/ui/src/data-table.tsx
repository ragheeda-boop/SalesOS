...
export function DataTable<TData>({
  ...
  const handleSelectChange: OnChangeFn<RowSelectionState> = useCallback(
    (updater) => {
              ...
              {headerGroup.headers.map((header) => (
                <th
                  ...
                  className={cn(
                    ...
                    sortable && header.column.getCanSort() && 'cursor-pointer select-none hover:bg-[var(--bg-tertiary)]'
                  )}
                  style={{ width: header.getSize() }}
