...
export const RadioGroup = forwardRef<HTMLDivElement, RadioGroupProps>(
  ({ name, options, value, defaultValue, onChange, label, error, disabled, orientation = 'vertical', className }, ref) => {
    ...
    return (
      <div ref={ref} className={cn('flex flex-col', className)}>
        {label && (
          <span id={`${groupName}-label`} className="mb-2 text-sm font-medium text-[var(--text-secondary)]">
            {label}
          </span>
        )}
        <div
