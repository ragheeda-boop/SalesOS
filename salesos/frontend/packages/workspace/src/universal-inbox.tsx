...
export type InboxItemType =
  "task" | "approval" | "recommendation" | "ai-insight" | "mention" | "notification" | "alert";
  ...
  return (
    <div className={cn("flex h-full flex-col", className)}>
      <div className="flex items-center justify-between border-b border-gray-200 px-4 py-3 dark:border-gray-700">
        ...
        <button
          ...
          className={cn(
            ...
            showUnread ? "bg-blue-100 text-blue-700" : "text-gray-500 hover:bg-gray-100"
          )}
        >
          غير مقروء
        </button>
      ...
      <div className="flex gap-1 overflow-x-auto border-b border-gray-200 px-4 py-2 dark:border-gray-700">
        ...
        {(Object.entries(typeConfig) as [InboxItemType, (typeof typeConfig)[InboxItemType]][]).map(
          ([type, config]) => (
            <button
              key={type}
