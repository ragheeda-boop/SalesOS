    ...
    <div className={cn("space-y-6", className)}>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span
                    className={cn(
                      ...
                      account.probability >= 70
                        ? "bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-300"
                        : account.probability >= 40
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <div className="rounded-xl border bg-white p-5 dark:border-gray-700 dark:bg-gray-900">
          ...
          <div className="space-y-2">
            {metrics.decisions.slice(0, 5).map((decision) => (
              <div
                key={decision.id}
                className="flex items-start gap-3 border-b border-gray-100 pb-2 last:border-0 dark:border-gray-800"
              >
        ...
        <div className="rounded-xl border bg-white p-5 dark:border-gray-700 dark:bg-gray-900">
          ...
          <BarChart data={metrics.weeklyTrend} height={180} />
        </div>
      </div>
    </div>
  );
