import { DEFAULT_NOTE_MAPPINGS, NOTE_PII_SCRUB_CATEGORIES, isNoteModel } from "../odooNoteHonesty";
...
describe("odooNoteHonesty — FE-S09-03", () => {
  it("mirrors tip mail.message mappings including body", () => {
    ...
    expect(DEFAULT_NOTE_MAPPINGS.some((m) => m.external === "body" && m.internal === "body")).toBe(
      true
    );
  });
