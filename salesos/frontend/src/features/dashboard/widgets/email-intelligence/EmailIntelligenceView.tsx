...
export function EmailIntelligenceView({
 ...
 if (isLoading) {
 return (
 <div className="flex items-center justify-center h-full" role="status" aria-label="جار التحميل">
 ...
 <StatCard label="معدل الرد" value={`${replyRatePct}%`} color="text-[var(--status-warning-text)]" />
 <StatCard
 label="متوسط الرد"
