...
const sampleItems: ActivityItem[] = [
  ...
  },
  {
    id: "a2",
    type: "decision",
    title: "قرار تمديد العقد مع سابك",
    companyId: "c2",
    companyName: "سابك",
  ...
  },
  {
    id: "a3",
    type: "update",
    title: "تحديث بيانات الاتصال للشركة",
    companyId: "c3",
    companyName: "الراجحي",
    timestamp: "2026-07-09T16:45:00.000Z",
  },
  {
    id: "a4",
    type: "note",
    title: "ملاحظة: اجتماع مع فريق المبيعات",
    companyId: "c4",
    companyName: "STC",
...
describe("RecentActivityView", () => {
  ...
  it("supports keyboard Enter on clickable item", () => {
    const onItemClick = jest.fn();
    renderView({ onItemClick });
    fireEvent.keyDown(screen.getByLabelText(/إشارة مناقصة جديدة من أرامكو/), {
      key: "Enter",
    });
    expect(onItemClick).toHaveBeenCalledWith("a1");
  });
