...
const CATEGORY_CONFIG = {
  ...
  regulatory: { dot: "bg-[var(--chart-purple)]", label: "تنظيمي" },
    ...
    <div role="region" aria-label="Intelligence Feed" className="space-y-2">
      ...
      {items.length === 0 && (
        <EmptyState
          ...
          title="لا توجد إشارات جديدة"
          description="ستظهر الإشارات الذكية هنا عند توفرها"
        />
      )}
    </div>
  );
