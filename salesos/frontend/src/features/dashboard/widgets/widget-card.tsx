...
export function WidgetCard<T>({ widget, widgetId, children }: WidgetCardProps<T>) {
 ...
 {widget.status === 'error' && (
 <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%', minHeight: 120, color: 'var(--danger-700, #991b1b)', fontSize: '0.875rem' }}>
 <span>⚠</span>
