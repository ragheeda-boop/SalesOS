...
function SkeletonStages() {
 ...
 <div className="flex-1 h-2 animate-pulse rounded-full bg-[var(--bg-tertiary)]" />
...
export function PipelineView({
 ...
 return <EmptyState icon={<span className="text-2xl">📊</span>} title="لا توجد بيانات الأنبوب" description="ستظهر صفقاتك هنا عند إضافتها" />
 }
