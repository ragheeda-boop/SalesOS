...
export function DashboardMetricsHeader() {
 ...
 ariaLabel: t('mission.aria.companies_tracked', { count: missionData.companiesTracked }),
 },
 {
 ...
 ariaLabel: t('mission.aria.active_deals', { count: missionData.activeDeals }),
 },
 {
 ...
 ariaLabel: t('mission.aria.pipeline_value', { value: missionData.pipelineValue.toLocaleString() }),
 },
 {
 ...
 colorClass: 'bg-info-50 dark:bg-info-950/30',
 ariaLabel: t('mission.aria.signals_today', { count: missionData.signalsToday }),
 },
 {
 ...
 ariaLabel: t('mission.aria.decisions_pending', { count: missionData.decisionsPending }),
 },
 ]
