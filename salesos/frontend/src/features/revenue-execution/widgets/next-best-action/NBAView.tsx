...
const PRIORITY_CFG = {
  ...
  high: {
    label: "عالي — هذا الأسبوع",
    color:
      "bg-orange-50 text-orange-700 dark:bg-orange-900/20 dark:text-orange-300 ring-1 ring-orange-200 dark:ring-orange-800",
  ...
  low: {
    label: "منخفض — مراقبة",
    color:
      "bg-[var(--bg-secondary)] text-[var(--text-secondary)] ring-1 ring-neutral-200 dark:ring-neutral-700",
  ...
  return (
    ...
    >
      ...
      <div className="rounded-lg border border-primary-200 bg-primary-50/50 p-3 dark:border-primary-800 dark:bg-primary-900/10">
        ...
        <p className="mt-2 text-sm leading-relaxed text-primary-800 dark:text-primary-200">
          {action.reasoning}
        </p>
        ...
        <div className="mt-3 grid grid-cols-3 gap-2">
          <div className="rounded-lg bg-[var(--bg-primary)]/60 p-2/60">
            ...
            <p className="text-sm font-bold text-[var(--text-primary)]">
              $
              {action.expectedRevenue >= 1_000_000
                ? (action.expectedRevenue / 1_000_000).toFixed(1) + "M"
          ...
          <div className="rounded-lg bg-[var(--bg-primary)]/60 p-2/60">
            ...
            <p className="text-sm font-bold capitalize text-[var(--text-primary)]">
