...
export function OpportunityListView({ opportunities, onSelect }: OpportunityListViewProps) {
 ...
 className="w-full rounded-lg border border-[var(--border-color)] bg-transparent px-2 py-1.5 pr-8 text-xs text-[var(--text-primary)] placeholder:text-[var(--text-muted)] focus:border-primary-500 focus:outline-none"
 />
 </div>
