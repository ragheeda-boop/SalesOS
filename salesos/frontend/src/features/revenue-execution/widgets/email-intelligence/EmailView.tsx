...
const PRIORITY_S = { high: 'text-[var(--status-danger-text)]', medium: 'text-[var(--status-warning-text)]', low: 'text-[var(--status-success-text)]' }
...
export function EmailView({ emails }: EmailViewProps) {
 ...
 <div className="mt-1 flex items-start gap-1">
        ...
        <p className="text-[10px] text-[var(--chart-purple)] dark:text-[var(--chart-purple)]">{email.summary}</p>
 </div>
