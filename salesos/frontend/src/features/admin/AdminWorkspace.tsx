...
function QuickActions({ onNavigate }: { onNavigate: (tab: AdminTab) => void }) {
  ...
  const actions = [
    {
      labelKey: "admin.action.manage_tenants",
      descKey: "admin.action.manage_tenants_desc",
      tab: "tenants" as AdminTab,
      icon: Building2,
    },
    {
      labelKey: "admin.action.manage_plans",
      descKey: "admin.action.manage_plans_desc",
      tab: "plans" as AdminTab,
      icon: KeyRound,
    },
    {
      labelKey: "admin.action.manage_users",
      descKey: "admin.action.manage_users_desc",
      tab: "users" as AdminTab,
      icon: Users,
    },
    {
      labelKey: "admin.action.feature_flags",
      descKey: "admin.action.feature_flags_desc",
      tab: "flags" as AdminTab,
      icon: Flag,
    },
    {
      labelKey: "admin.action.background_jobs",
      descKey: "admin.action.background_jobs_desc",
      tab: "jobs" as AdminTab,
      icon: Briefcase,
    },
    {
      labelKey: "admin.action.system_health",
      descKey: "admin.action.system_health_desc",
      tab: "health" as AdminTab,
      icon: HeartPulse,
    },
    {
      labelKey: "admin.action.ai_audit",
      descKey: "admin.action.ai_audit_desc",
      tab: "ai-audit" as AdminTab,
      icon: DollarSign,
    },
  ];
