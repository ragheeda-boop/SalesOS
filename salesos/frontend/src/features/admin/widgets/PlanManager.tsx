...
export function PlanManager() {
 ...
 return <div className="py-20 text-center text-[var(--text-muted)]"><Spinner /> جاري التحميل...</div>
 }
 ...
 <input className="border rounded px-3 py-2 text-sm" placeholder="الاسم" value={planForm.name} onChange={(e) => setPlanForm({ ...planForm, name: e.target.value })} />
 ...
 <input className="border rounded px-3 py-2 text-sm" type="number" placeholder="السعر الشهري" value={planForm.price_monthly} onChange={(e) => setPlanForm({ ...planForm, price_monthly: Number(e.target.value) })} />
 <input className="border rounded px-3 py-2 text-sm" type="number" placeholder="الحد الأقصى للمستخدمين" value={planForm.max_users} onChange={(e) => setPlanForm({ ...planForm, max_users: Number(e.target.value) })} />
 <input className="border rounded px-3 py-2 text-sm" type="number" placeholder="المساحة (MB)" value={planForm.max_storage_mb} onChange={(e) => setPlanForm({ ...planForm, max_storage_mb: Number(e.target.value) })} />
 <input className="border rounded px-3 py-2 text-sm" type="number" placeholder="الاستدعاءات" value={planForm.max_api_calls} onChange={(e) => setPlanForm({ ...planForm, max_api_calls: Number(e.target.value) })} />
 <input className="border rounded px-3 py-2 text-sm col-span-full" placeholder="الميزات (مفصولة بفاصلة)" value={planForm.features} onChange={(e) => setPlanForm({ ...planForm, features: e.target.value })} />
 </div>
 <div className="flex gap-2">
 ...
 <input className="border rounded px-3 py-2 text-sm" placeholder="معرف العميل (tenant_id)" value={licenseForm.tenant_id} onChange={(e) => setLicenseForm({ ...licenseForm, tenant_id: e.target.value })} />
 <input className="border rounded px-3 py-2 text-sm" placeholder="معرف الباقة (plan_id)" value={licenseForm.plan_id} onChange={(e) => setLicenseForm({ ...licenseForm, plan_id: e.target.value })} />
 </div>
 <div className="flex gap-2">
 ...
 <p className="text-sm text-[var(--text-muted)] text-center py-4">لا توجد تراخيص</p>
 )}
 </div>
 </Card>
 </div>
