...
export function TenantList() {
 ...
 {isLoading ? (
 <div className="py-20 text-center text-[var(--text-muted)]"><Spinner /> جاري التحميل...</div>
 ) : !tenants?.length ? (
 ...
 <td className="p-2 text-xs text-[var(--text-muted)] font-mono" data-label="المعرف">{tenant.slug}</td>
 ...
 <td className="p-2 text-xs text-[var(--text-muted)]" data-label="تاريخ الإنشاء">
