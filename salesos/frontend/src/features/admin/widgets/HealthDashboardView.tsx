...
export function HealthDashboardView({ health, history, loading }: HealthDashboardViewProps) {
 ...
 <p className="text-xs text-[var(--text-muted)]">مدة التشغيل</p>
 </div>
 <div className="rounded-xl border border-[var(--border-default)] bg-[var(--bg-primary)] p-4">
 <div className="flex items-center gap-2 mb-2">
 ...
 <p className="text-xs text-[var(--text-muted)]">مكونات النظام</p>
 </div>
 <div className="rounded-xl border border-[var(--border-default)] bg-[var(--bg-primary)] p-4">
 <div className="flex items-center gap-2 mb-2">
 ...
 <p className="text-xs text-[var(--text-muted)]">سليمة</p>
 </div>
 <div className="rounded-xl border border-[var(--border-default)] bg-[var(--bg-primary)] p-4">
 <div className="flex items-center gap-2 mb-2">
 ...
 <p className="text-xs text-[var(--text-muted)]">فحوصات سابقة</p>
 </div>
 </div>
 ...
 <p className="text-xs text-[var(--text-muted)] mt-1">الاستجابة: {comp.latency_ms}ms</p>
 )}
 {comp.details && (
 ...
 <p className="text-sm text-[var(--text-muted)] text-center py-4">لا توجد بيانات تاريخية</p>
 )}
 </Card>
 </div>
 )
