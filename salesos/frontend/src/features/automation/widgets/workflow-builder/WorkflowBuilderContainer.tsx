...
import { useWorkflows, useCreateWorkflow, useUpdateWorkflow, useDeleteWorkflow, useExecuteWorkflow, type Workflow, type WorkflowStep } from "@/lib/workflowQueries"
...
export function WorkflowBuilderContainer() {
  ...
  const viewProps: WorkflowBuilderViewProps = {
    ...
    onFormClose: useCallback(() => { setShowForm(false); setEditing(null) }, []),
