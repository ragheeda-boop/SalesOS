...
function WorkflowExecutionHistory() {
 ...
 <h2 className="text-lg font-display text-[var(--text-primary)]">{t("automation.execution_history")}</h2>
 ...
 {ex.status ==="success" ? t("automation.success") : ex.status ==="failed" ? t("automation.failed") : t("automation.in_progress")}
 </span>
