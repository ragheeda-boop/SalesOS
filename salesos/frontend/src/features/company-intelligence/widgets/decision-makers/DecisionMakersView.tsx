...
const INF_C = { high: 'text-[var(--status-success-text)]', medium: 'text-[var(--status-warning-text)]', low: 'text-[var(--text-disabled)]' }
...
export function DecisionMakersView({ makers }: DecisionMakersViewProps) {
 ...
 {m.connected && <Star className="h-3 w-3 shrink-0 fill-amber-400 text-[var(--status-warning-text)]" />}
