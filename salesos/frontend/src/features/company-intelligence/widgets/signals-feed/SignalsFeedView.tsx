...
const SEV_C = {
  ...
  medium: "text-[var(--status-warning-text)] bg-[var(--status-warning-bg)]",
  high: "text-orange-600 bg-orange-50 dark:bg-orange-900/20 dark:text-orange-300",
  critical: "text-[var(--status-danger-text)] bg-[var(--status-danger-bg)]",
};
      ...
      {signals.map((s, i) => (
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="mt-0.5 text-[10px] text-[var(--text-muted)] line-clamp-1">
              {s.description}
            </p>
