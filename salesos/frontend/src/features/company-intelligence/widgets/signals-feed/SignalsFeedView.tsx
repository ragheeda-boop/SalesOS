...
const SEV_C = { low: 'text-[var(--text-muted)] bg-[var(--bg-secondary)]', medium: 'text-[var(--status-warning-text)] bg-[var(--status-warning-bg)]', high: 'text-orange-600 bg-orange-50 dark:bg-orange-900/20 dark:text-orange-300', critical: 'text-[var(--status-danger-text)] bg-[var(--status-danger-bg)]' }
