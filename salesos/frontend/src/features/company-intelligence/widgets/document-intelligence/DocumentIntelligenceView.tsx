...
export function DocumentIntelligenceView({ documents }: DocumentIntelligenceViewProps) {
 ...
 <span className="shrink-0 rounded bg-[var(--bg-tertiary)] px-1 py-0.5 text-[9px] text-[var(--text-muted)]">
 ...
 <div className="mt-0.5 flex items-start gap-1">
          ...
          <p className="text-[10px] text-[var(--chart-purple)] dark:text-[var(--chart-purple)] line-clamp-2">{doc.aiSummary}</p>
 </div>
 )}
