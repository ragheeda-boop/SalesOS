...
const STATUS_V = {
  ...
  expired: "bg-[var(--status-danger-bg)] text-red-700",
  pending: "bg-[var(--status-warning-bg)] text-amber-700",
  violation: "bg-[var(--status-danger-bg)] text-red-700",
};
const STATUS_L = {
  active: "ساري",
  expired: "منتهي",
