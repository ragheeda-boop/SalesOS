...
type RelationshipType =
  "competitor" | "partner" | "subsidiary" | "parent" | "supplier" | "customer";
...
const RELATION_COLORS: Record<RelationshipType, string> = {
  ...
  customer:
    "bg-[var(--color-orange-bg)] text-[var(--color-orange)] border-[var(--color-orange-border)]",
};
...
function StrengthBar({ value }: { value: number }) {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <span className="text-[10px] font-medium text-[var(--text-muted)] w-8 text-left">
      ...
      <Card>
        ...
        <CardContent>
          <EmptyState
            ...
            title="فشل تحميل العلاقات"
            description="تعذر تحميل بيانات شبكة العلاقات"
          />
        </CardContent>
      </Card>
    );
      ...
      <Card>
        ...
        <CardContent>
          <EmptyState
            ...
            description="لم يتم العثور على علاقات لهذه الشركة"
          />
        </CardContent>
      </Card>
    );
