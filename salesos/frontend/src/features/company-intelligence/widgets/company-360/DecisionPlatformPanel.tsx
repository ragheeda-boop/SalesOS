...
export function DecisionPlatformPanel({
  companyId,
      ...
      <Card>
        ...
        <CardContent>
          <EmptyState
            ...
            description="تعذر تحميل توصيات منصة القرارات"
          />
        </CardContent>
      </Card>
    );
      ...
      <Card>
        ...
        <CardContent>
          <EmptyState
            icon={<Sparkles className="h-10 w-10" />}
            title="لا توجد توصيات"
            description="لم يتم العثور على توصيات أو تقييمات لهذه الشركة"
          />
        </CardContent>
      </Card>
    );
              ...
              <div className="space-y-1.5">
                {riskFlags.map(
                  (
                    ...
                    <div
                      key={i}
                      className="flex items-center gap-2 rounded-lg bg-[var(--color-danger-bg)]/50 px-3 py-2"
                    >
