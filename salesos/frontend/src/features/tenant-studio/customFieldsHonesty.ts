...
export const CUSTOM_FIELDS_HONESTY =
  "Tip POST/GET /api/v1/studio/custom-fields defines versioned scalar fields (string|number|date|enum) with reserved-column collision checks. Store is process-local in-memory — not Postgres.";
