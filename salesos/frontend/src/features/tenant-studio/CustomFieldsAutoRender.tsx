...
export function CustomFieldsAutoRender({
  ...
  return (
    ...
    >
      ...
      >
        Tip GET .../form-schema returns Form Engine descriptors
        (renderer=custom_fields_auto). POST .../values projects
        metadata.custom_fields for known keys only — no ORM write / no Postgres
