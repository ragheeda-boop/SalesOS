...
jest.mock("../../../widgets/customer-success/AdoptionChart", () => ({
  AdoptionChart: ({ data: _data }: { data: unknown }) => (
...
jest.mock("../../../widgets/customer-success/SearchSuccessWidget", () => ({
  SearchSuccessWidget: ({
    ...
    <div data-testid="search-success-widget">
      Searches: {total_searches} Rate: {success_rate}
    </div>
  ),
}));
jest.mock("../../../widgets/customer-success/NBAAcceptanceWidget", () => ({
  NBAAcceptanceWidget: ({
    ...
    <div data-testid="nba-acceptance-widget">
      Views: {nba_views} Rate: {acceptance_rate}
    </div>
  ),
}));
...
const mockedUseTelemetryOverview = useTelemetryOverview as jest.MockedFunction<
  typeof useTelemetryOverview
>;
...
describe("CustomerSuccessWorkspace", () => {
  it("shows loading skeleton when loading", () => {
    mockedUseTelemetryOverview.mockReturnValue({
      data: null,
      isLoading: true,
    } as any);
