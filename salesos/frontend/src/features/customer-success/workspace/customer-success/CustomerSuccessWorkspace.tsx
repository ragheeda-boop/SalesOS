  ...
  return (
    <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="rounded-xl border border-[var(--border-default)] bg-[var(--bg-primary)] p-4">
              <h3 className="text-sm font-semibold text-[var(--text-primary)] mb-4">
                {t("customer_success.feature_adoption")}
              </h3>
              <AdoptionChart data={feature_adoption} />
            </div>
            <div className="rounded-xl border border-[var(--border-default)] bg-[var(--bg-primary)] p-4">
              <h3 className="text-sm font-semibold text-[var(--text-primary)] mb-4">
                {t("customer_success.customer_health")}
              </h3>
              <TenantHealthList
                tenants={[
                  {
                    ...
                    components: {
                      feature_adoption: {
                        weight: 0.4,
                        value: avg_adoption_pct,
                        contribution: 0,
                      },
                      search_success: {
                        weight: 0.3,
                        value: search_success.success_rate,
                        contribution: 0,
                      },
                      nba_acceptance: {
                        weight: 0.3,
                        value: nba_acceptance.acceptance_rate,
                        contribution: 0,
                      },
                    },
      ...
      {activeView === "tenants" && (
        <div className="rounded-xl border border-[var(--border-default)] bg-[var(--bg-primary)] p-4">
          <h3 className="text-sm font-semibold text-[var(--text-primary)] mb-4">
            {t("customer_success.tenant_list")}
          </h3>
          <TenantHealthList
            tenants={[
              {
