...
function CommandBarInner({
  ...
  const toggle = useCallback(() => {
    setOpen((prev) => !prev);
    if (!open) {
      searchTelemetry.record("search.command_bar_open", {
        metadata: { trigger: "keyboard" },
      });
    }
  }, [open]);
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <div className="flex items-center gap-3 border-t border-[var(--border-color)] px-4 py-2 text-[10px] text-[var(--text-muted)]">
          <span>↑↓ للتنقل</span>
