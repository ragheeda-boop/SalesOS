...
export const NBA_TOUR: TourStep[] = [
  {
    ...
    description:
      "تعرض هذه الواجهة الإجراءات المقترحة التي يجب عليك اتخاذها بناءً على تحليل الذكاء الاصطناعي.",
    position: "top",
  },
  {
  ...
  },
  {
    ...
    title: "قبول أو رفض",
    description:
      "يمكنك قبول التوصية لتنفيذ الإجراء، أو رفضها مع توضيح السبب لتحسين التوصيات المستقبلية.",
    position: "top",
  },
  {
