...
export const LazyExecutiveDashboard = dynamic(
 ...
 { ssr: false, loading: () => <div className="h-64 animate-pulse rounded-lg bg-[var(--bg-tertiary)]" /> }
)

export const LazyTimelineWidget = dynamic(
 () => import("@/components/timeline-widget").then((m) => m.TimelineWidget),
 { ssr: false, loading: () => <div className="h-48 animate-pulse rounded-lg bg-[var(--bg-tertiary)]" /> }
)

export const LazyPipelineKanban = dynamic(
 () => import("@/components/pipeline-kanban").then((m) => m.PipelineKanban),
 { ssr: false, loading: () => <div className="h-96 animate-pulse rounded-lg bg-[var(--bg-tertiary)]" /> }
)
