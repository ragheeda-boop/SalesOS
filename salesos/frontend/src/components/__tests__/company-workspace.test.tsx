...
jest.mock(
  "@/features/company-intelligence/widgets/relationship-graph/RelationshipGraphContainer",
  () => ({
...
jest.mock(
  "@/features/company-intelligence/widgets/ai-recommendation/AIRecommendationContainer",
  () => ({
...
describe("CompanyWorkspace", () => {
  ...
  it("hides English name when same as Arabic", () => {
    mockUseCompany.mockReturnValue({
      data: makeCompany({ name_en: "شركة أرامكو" }),
      isLoading: false,
      isError: false,
    });
    mockUseCompany360.mockReturnValue({ data: {} });
  ...
  it("uses confidence_score as fallback for health", () => {
    mockUseCompany.mockReturnValue({
      data: makeCompany({ confidence_score: 90 }),
      isLoading: false,
      isError: false,
    });
    mockUseCompany360.mockReturnValue({ data: {} });
