...
export default function V3CsPage() {
 ...
 queryKey: companyKeys.list({ page: 1, page_size: 8, sort_by: 'name_ar', sort_order: 'asc' }),
 queryFn: () =>
 searchCompanies(
 ...
 <div className="flex items-center gap-2">
 <PreviewBadge />
 <span className="text-[12px] text-[var(--text-muted)]">Object model — not dual-run</span>
 </div>
 <p>
