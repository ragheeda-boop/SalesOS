...
function PreviewPanel({
 ...
 <PreviewBadge />
 <span className="text-[12px] text-[var(--text-muted)]">Not wired — no invented metrics</span>
 </div>
 <p>{children}</p>
...
export default function V3AnalyticsPage() {
 ...
 section shows the executive <code className="font-mono text-[12px]">forecast</code> field
 only — treat it as a stored number, not a governance commit.
 </PreviewPanel>
 ),
 },
 {
