...
export default function V3TaskDetailPage() {
 ...
 title="Task"
 actions={
 <Link href="/v3/tasks" className="text-sm text-[var(--text-secondary)] hover:underline">
 Back to tasks
 </Link>
 }
 />
 ...
 Company detail could not be loaded. You can still open Company 360 with the linked
 id.
 </p>
 ) : null}
