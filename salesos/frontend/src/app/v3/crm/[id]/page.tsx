...
function OverviewTab({ deal }: { deal: Opportunity }) {
 ...
 <Field label="Won amount" value={deal.won_amount != null ? formatValue(deal.won_amount, currency) : null} />
 ...
 <p className="text-sm text-[var(--text-secondary)] whitespace-pre-wrap">{deal.description}</p>
 </section>
 ) : (
