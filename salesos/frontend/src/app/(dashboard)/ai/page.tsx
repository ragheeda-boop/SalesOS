...
export default function AIPage() {
  ...
  const handleTest = async () => {
    ...
    try {
      ...
      setTestResult("Error generating output");
    }
    setEvaluating(false);
  };
            ...
            >
              ...
              {p.metrics && (
                <div className="flex gap-3 mt-1 text-xs text-[var(--text-muted)]">
                  <span>
                    {t("ai.accuracy")}: {p.metrics.accuracy}%
                  </span>
            ...
            <div className="rounded-lg border p-4 bg-[var(--bg-primary)] space-y-3">
              <div className="flex items-center justify-between">
                <h3 className="font-bold">
                  {selected.name}{" "}
                  <span className="text-[var(--text-disabled)] font-normal">
                    v{selected.version}
                  </span>
                </h3>
                <button
              ...
              <div>
                ...
                <pre className="mt-1 p-3 bg-[var(--bg-secondary)] rounded text-sm whitespace-pre-wrap">
