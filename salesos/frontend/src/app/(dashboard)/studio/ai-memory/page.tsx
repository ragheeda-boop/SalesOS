...
export default function AiMemoryPage() {
  return (
    <div className="space-y-6 p-6" data-testid="ai-memory-page">
      <div>
        <h1 className="text-2xl font-bold text-[var(--text-primary)]">AI Memory</h1>
        <p className="mt-1 text-sm text-[var(--text-muted)]">
          Tip conversation-level memory against /api/v1/studio/ai-memory. In-memory CAP-063; opt-in;
          cross-session deferred. Live LLM not claimed.
        </p>
      </div>
      <AiMemoryStudio />
