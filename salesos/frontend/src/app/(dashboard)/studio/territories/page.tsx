    ...
    <div className="space-y-6 p-6" data-testid="territories-studio-page">
      <div>
        ...
        <p className="mt-1 text-sm text-[var(--text-muted)]">
          Geography / industry / size territory rules via tip
          /api/v1/studio/territories. Unmatched does not invent a key. Live
          revenue DB / 141221 not claimed.
        </p>
      </div>
      <TerritoriesStudio />
      <p className="text-xs text-[var(--text-muted)]">
        ...
        <Link
          href="/studio/scoring"
          className="underline"
          data-testid="territories-scoring-link"
        >
          /studio/scoring
        </Link>
        .
