    ...
    <div className="space-y-6 p-6" data-testid="permissions-studio-page">
      <div>
        ...
        <p className="mt-1 text-sm text-[var(--text-muted)]">
          Define tenant-custom roles capped at Plan.entitlements ceiling against
          tip Tenant Studio HTTP. Privilege escalation is blocked (403).
        </p>
      </div>
      <PermissionsStudio />
      <p className="text-xs text-[var(--text-muted)]">
        ...
        <Link
          href="/studio/scoring"
          className="underline"
          data-testid="permissions-scoring-link"
        >
          /studio/scoring
        </Link>
        .
