...
export default function LeadDiscoveryPage() {
  return (
    <div className="space-y-6 p-6" data-testid="lead-discovery-page">
      <div>
        <h1 className="text-2xl font-bold text-[var(--text-primary)]">Lead Discovery</h1>
        <p className="mt-1 text-sm text-[var(--text-muted)]">
          Government-data-first sourcing with Integration Hub provider fallback via tip POST/GET
