    ...
    <div className="space-y-6 p-6" data-testid="lookalike-page">
      <div>
        ...
        <p className="mt-1 text-sm text-[var(--text-muted)]">
          Rank similar accounts from tip POST/GET /api/v1/gtm/lookalikes using
          won/lost Opportunity-shaped history (CI fixtures — not live ML).
        </p>
      </div>
      <LookalikePanel />
      <p className="text-xs text-[var(--text-muted)]">
        ...
        <Link
          href="/gtm"
          className="underline"
          data-testid="lookalike-hub-link"
        >
          /gtm
        </Link>
        .
