  ...
  const handleCreate = useCallback(async () => {
    ...
    try {
      ...
      toast({
        ...
        description: detail || t("contacts.add_error"),
      });
    }
  ...
  const handleEdit = useCallback(async () => {
    ...
    try {
      ...
      toast({
        ...
        description: detail || t("contacts.update_error"),
      });
    }
  ...
  const handleDelete = useCallback(async () => {
    ...
    try {
      ...
      toast({
        ...
        description: detail || t("contacts.delete_error"),
      });
    }
              ...
              <div className="flex flex-col gap-3">
                ...
                <div>
                  ...
                  {selectedCompany ? (
                    ...
                    <>
                      <Input
                        placeholder={t("contacts.company_search")}
                        value={companySearch}
          ...
          <table className="w-full text-right responsive-table">
            ...
            <tbody className="divide-y divide-neutral-100">
              {data.items.map((contact: Contact) => (
                <tr
                  key={contact.id}
                  className="text-sm text-[var(--text-secondary)] hover:bg-[var(--bg-secondary)]"
                >
                  <td
                    className="px-4 py-3 font-medium text-[var(--text-primary)]"
                    data-label={t("contacts.name")}
                  >
                    {contact.name}
                  </td>
                  ...
                  <td className="px-4 py-3" data-label={t("contacts.company")}>
                    {contact.company_id ? (
                      <Link
                        ...
                        className="flex items-center gap-1 text-[var(--muhide-orange)] hover:underline"
                      >
                    ...
                    <div className="flex items-center gap-1">
                      <Tooltip content={t("contacts.edit_tooltip")} side="top">
                        <button
                          ...
                          className="rounded p-1 text-[var(--text-disabled)] hover:bg-[var(--bg-tertiary)] hover:text-[var(--muhide-orange)]"
                        >
                      ...
                      >
                        <button
                          ...
                          className="rounded p-1 text-[var(--text-disabled)] hover:bg-[var(--bg-tertiary)] hover:text-danger-600"
                        >
            ...
            {Array.from({ length: Math.min(totalPages, 7) }, (_, i) => {
              ...
              return (
                <button
                  key={p}
                  onClick={() => setPage(p)}
                  className={`h-8 w-8 rounded-md text-sm ${p === page ? "bg-[var(--muhide-orange)] text-white" : "text-[var(--text-secondary)] hover:bg-[var(--bg-tertiary)]"}`}
                >
                  {p}
                </button>
              );
      ...
      >
        <ModalContent>
          ...
          <ModalFooter>
            ...
            <Button
              onClick={handleEdit}
              disabled={!formData.name.trim() || updateContact.isPending}
            >
