...
export default function AnalyticsOverviewPage() {
  ...
  if (error || execError) {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center">
        ...
        <p className="text-sm text-[var(--danger-500)] mb-4">
  ...
  const overviewMetrics: OverviewMetrics = {
    ...
    workflows_trend: 0,
    conversion_rate:
      pipeline && pipeline.total_deals > 0
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <MetricCard
          ...
          trend={{
            direction: overviewMetrics.revenue_trend >= 0 ? "up" : "down",
            percentage: Math.abs(overviewMetrics.revenue_trend),
          }}
