...
export async function getEmployeePerformance(
  ...
  const response = await api.get(`/api/v1/employees/${employeeId}/performance`, {
    headers: { "X-Tenant-Id": tenantId },
  });
  return response.data;
}
...
export async function exportEmployees(
  ...
  const response = await api.get(`/api/v1/employees/export?${searchParams.toString()}`, {
    headers: { "X-Tenant-Id": tenantId },
    responseType: "blob",
  });
  return response.data;
...
export async function getEmployeeCalendarKPIs(
  ...
  const response = await api.get(`/api/v1/employees/${employeeId}/calendar-kpis`, {
    headers: { "X-Tenant-Id": tenantId },
  });
  return response.data;
}
...
export async function getEmployeeCalendarHeatmap(
  ...
  const response = await api.get(`/api/v1/employees/${employeeId}/calendar-heatmap`, {
    params: { days },
    headers: { "X-Tenant-Id": tenantId },
  });
  return response.data;
...
export async function getEmployeeEmailTopContacts(
  ...
  const response = await api.get(`/api/v1/employees/${employeeId}/email-top-contacts`, {
    params: { limit },
    headers: { "X-Tenant-Id": tenantId },
  });
  return response.data;
...
export async function getEmployeeEmailDailyVolume(
  ...
  const response = await api.get(`/api/v1/employees/${employeeId}/email-daily-volume`, {
    params: { days },
    headers: { "X-Tenant-Id": tenantId },
  });
  return response.data;
...
export async function getEmployeeProductivity(
  ...
  const response = await api.get(`/api/v1/employees/${employeeId}/productivity`, {
...
export async function getExecutiveSummary(tenantId: string): Promise<ExecutiveSummaryResponse> {
