...
export const employeeKeys = {
 ...
 timeline: (id: string, params: Record<string, unknown>) => [...employeeKeys.all,"timeline", id, params] as const,
	...
	calendarHeatmap: (id: string, days: number) => [...employeeKeys.all,"calendar-heatmap", id, days] as const,
	...
	emailDailyVolume: (id: string, days: number) => [...employeeKeys.all,"email-daily-volume", id, days] as const,
	productivity: (id: string, periodDays: number) => [...employeeKeys.all,"productivity", id, periodDays] as const,
	relationship: (id: string, targetType: string, targetId: string) => [...employeeKeys.all,"relationship", id, targetType, targetId] as const,
