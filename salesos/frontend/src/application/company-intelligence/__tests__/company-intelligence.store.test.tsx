...
const sampleDTO: CompanyIntelligenceDTO = {
  ...
  dna: {
    industry: "tech",
    businessModel: "b2b",
    size: { employees: 100, revenue: "10M", label: "smb" },
    growthPattern: "stable",
    buyingBehaviour: { score: 50, intent: "medium" },
    technologyProfile: {},
    financialHealth: { score: 70, revenue: 10_000_000, growth: 5, trend: "up" },
    governmentExposure: { level: "low", contracts: 0 },
    expansionPotential: { score: 50, markets: [] },
    digitalPresence: { score: 50, website: "active", social: "active" },
    hiringTrend: { trend: "stable", openings: 10 },
    procurementMaturity: { score: 50, level: "basic" },
    relationshipStrength: { score: 50, connections: 5 },
    buyingIntent: { score: 50, confidence: 0.5 },
    riskLevel: { score: 30, level: "low" },
    confidenceScore: 0.5,
    dataFreshness: { score: 80, updatedAt: "2026-07-11" },
    goldenRecordStatus: { status: "clean", sources: 2 },
  },
  aiRecommendation: {
    action: "follow_up",
    actionLabel: "متابعة",
