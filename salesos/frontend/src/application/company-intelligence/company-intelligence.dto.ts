...
export interface CompanyDNA {
  ...
  size: {
    employees: number;
    revenue: string;
    label: "small" | "medium" | "large" | "enterprise";
  };
  ...
  digitalPresence: {
    score: number;
    website: "none" | "basic" | "active";
    social: "none" | "basic" | "active";
  };
  hiringTrend: { trend: "declining" | "stable" | "growing"; openings: number };
  procurementMaturity: {
    score: number;
    level: "initial" | "managed" | "defined" | "optimized";
  };
  ...
  goldenRecordStatus: {
    status: "clean" | "needs_review" | "conflict";
    sources: number;
  };
}
