...
} from "@/application/revenue-execution/opportunity.store";
import {
...
const dna: CompanyDNA = {
  ...
  expansionPotential: { score: 72, markets: [] },
  ...
  dataFreshness: { score: 90, updatedAt: "2026-07-10" },
