...
| **`feature_ai_copilot` flag** | **True in code** vs **False mandated by AI_HONESTY.md** | See F-04 finding |
...
| AI Copilot | Backend enabled with `feature_ai_copilot=True`; **provider is DEV-ONLY** |
